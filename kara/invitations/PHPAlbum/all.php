...
if(empty($halaman)){
	...
	$s=mysql_query("SELECT * FROM invitation where id_category in (25,24,26,31) ORDER BY id_product DESC LIMIT $posisi,$batas");
	if($s === FALSE){
		die(mysql_error());
	...
	//Paging 
	$query = mysql_query("SELECT * FROM invitation where id_category in (25,24,26,31)");
