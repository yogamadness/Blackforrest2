...
<body>
	...
	<section id="bannerproduct" style="">
		<span><img src="../../image/kara-banner1.jpg" alt="Banner - Take This Journey With Me"></span><br>
		<div id="about" class="kata" >
        <p style="font-size:26px; font-weight:bold; font-family: Times New Roman, serif; letter-spacing: 10px">KARA INVITATIONS GALLERY</p><br> 
	    </div>
		<div class="container">
			<div class="row">
				<div class="col-sm-3">
