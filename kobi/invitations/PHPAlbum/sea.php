...
if(empty($halaman)){
	...
	$s = mysql_query("SELECT * FROM invitation WHERE id_category LIKE '23' LIMIT $posisi,$batas");
	...
	//Paging 
	$query = mysql_query("SELECT * FROM invitation WHERE id_category LIKE '23'");
	...
	for ($i=1; $i<=$total_pages; $i++) { 
            echo "<li class='p$i page'><a href='invitations.php?page=sea&halaman=".$i."'>".$i."</a></li> "; 
	}; 
