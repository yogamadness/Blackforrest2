...
<meta name="Description" content="Perfect Invitations for Your Occasions">
<title>Kobi Invitations</title>

<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
<link rel="shortcut icon" type="image/x-icon"  href="../../image/iconkobi.ico" />
	<title>Product</title>
...
.glyphicon {
 ...
 #bannerproduct {
	...
	background: rgb(253, 145, 178);	
	}
		
	body#bab a#invitationsnav {
...
<body>
	...
	<section id="bannerproduct" style="">
		<span><img src="../../image/kobi-banner1.jpg" alt="Banner - Take This Journey With Me"></span><br>
		<div id="about" class="kata" >
        <p style="font-size:26px; font-weight:bold; font-family: Times New Roman, serif; letter-spacing: 10px">KOBI INVITATIONS GALLERY</p><br> 
	    </div>
		<div class="container">
			<div class="row">
				<div class="col-sm-3">
