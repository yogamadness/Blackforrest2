...
if(empty($halaman)){
	...
	$s=mysql_query("SELECT * FROM photobook  where id_category = 30 ORDER BY id_product DESC LIMIT $posisi,$batas");
	...
	//Paging 
	$query = mysql_query("SELECT * FROM photobook  where id_category = 30");
	...
	for ($i=1; $i<=$total_pages; $i++) { 
            echo "<li class='p$i page'><a href='photobook.php?page=gra&halaman=".$i."'>".$i."</a></li> "; 
	}; 
