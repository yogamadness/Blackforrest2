...
if(empty($halaman)){
	...
	$s = mysql_query("SELECT * FROM photobook WHERE id_category LIKE '25' LIMIT $posisi,$batas");
	...
	<a id='b$addition' href=photothumbnail.php?id=$w[product_name] data-fancybox-group='gallery'>
	...
	//Paging 
	$query = mysql_query("SELECT * FROM photobook WHERE id_category LIKE '25'");
	...
	for ($i=1; $i<=$total_pages; $i++) { 
            echo "<li class='p$i page'><a href='photobook.php?page=bab&halaman=".$i."'>".$i."</a></li> "; 
	}; 
