...
<!-- Fotorama -->
<button id="CloseButton" class="btn learnmore CloseBtn">X</button>
...
<div class="fotorama" data-nav="thumbs" data-arrows="true"
  ...
  <?php
					...
					$s = mysql_query("SELECT * FROM photobook where id_product = '$_GET[id]' ORDER BY id_product DESC LIMIT $posisi,$batas");
					...
					while ($w = mysql_fetch_array($s)) {
						...
						echo "<img src='../../adminbfc/uploads/$w[img1]'>
							  <img src='../../adminbfc/uploads/$w[img2]'>
							  <img src='../../adminbfc/uploads/$w[img3]'>";
					}
