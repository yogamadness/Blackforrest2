...
<body>
                    ...
                    <div class="col-lg-12">
                      ...
                      <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                    <div class="table">
                                        <table class="table table-striped table-bordered table-hover" id="listsubscribe">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Email</th>
    ...
    <script type="text/javascript" src="../include/subscribepage/clientside/subscribeController.js"></script>
